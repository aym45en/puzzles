...
function createTextFrame(page, content, number, topPosition, arialFont,verticalSpacing, pageWidth, leftMargin, rightMargin) {
    ...
    textFrame.contents = number + ". first encryption" + ' ' + contentS[0];
    textFrame.contents += "solution: " + ' ' + contentS[1];
    ...
    var firstWord1 = paragraph.words.item(contentS[0].split(' ').length+3);
    firstWord1.fontStyle = "Bold"; // Make the number bold
